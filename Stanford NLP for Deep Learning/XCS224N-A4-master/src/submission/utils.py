...
def pad_sents(sents, pad_token):
    ...
    # Pad each sentence
    sents_padded = [sent + ([pad_token] * (max_length - len(sent))) for sent in sents]   # pad with a list of pad_token (with len= difference in current sentence size & max sentence in this batch size)
